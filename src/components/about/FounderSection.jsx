            ...
            <div className="container">
                <div className="row align-center">
                    <div className="about-style-one col-xl-6 col-lg-5">
                        <div className="h4 sub-heading">Meet Our Founder</div>
                        <h2 className="title mb-25">Muhammad Imran Rana</h2>
                        <p>
                    ...
                    <div className="about-style-one col-xl-5 offset-xl-1 col-lg-6 offset-lg-1">
                        <div className="about-thumb">
                            <div className="h4 sub-heading">Vision for the Future</div>
                            <p>
