...
const RequestCallStyle1 = () => {
    return (
        <>
            <div className="request-call-back-area text-light default-padding" style={{ backgroundImage: `url(/assets/img/banner/bannercall.jpg)` }}>
                <div className="container">
                    <div className="row align-center">
                        <div className="col-lg-6">
                            <h2 className="title">Want to Empowering Your Business with Financial Security and Tailored IT Solutions?</h2>
